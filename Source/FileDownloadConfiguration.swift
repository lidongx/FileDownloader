...
public struct FileDownloadConfiguration {
    ...
    public static var defaultConfiguration: FileDownloadConfiguration
    = .init(maxRetries: 0, timeoutIntervalForRequest: 30, requestCachePolicy: .returnCacheDataElseLoad)
    public static var serverDefaultConfiguration: FileDownloadConfiguration =
        .init(maxRetries: 0, timeoutIntervalForRequest: 30, requestCachePolicy: .reloadIgnoringLocalAndRemoteCacheData)
}
